...
annotated_sample <- annotated_sample_raw <- mageck_counts %>% 
  ...
  mutate(sample_name=factor(sample_name,levels=c("A549_T0_Lib","A549_COV2_Rep1","A549_COV2_Rep2","A549_COV2_Rep3")))
...
p1 <- annotated_sample %>%  ggplot(aes(log(value))) +
